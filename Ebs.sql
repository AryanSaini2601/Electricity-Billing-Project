...
create table customer(name varchar(20), meter varchar(20), address varchar(50), city varchar(30), state varchar(20), email varchar(40), phone varchar(20));
...
ALTER TABLE customer RENAME COLUMN meter TO meter_no;
